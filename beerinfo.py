...
beer1name = "Black Is Beautiful" # 20 char limit
beer1srm = BLACK # srm color value
beer1style = "Imperial Stout" # 19 char limit
beer1OG = "OG: 1.077 SG" # layout like OG: #.### SG
beer1ibu = "IBU: 67.7" # layout like IBU: ##.#
beer1abv = "ABV: 8.9%/VOL" # layout like ABV: #.#%/VOL
beer1glasspic = pint # select from Beer Glass Variables
beer1textcolor = BLACK # text color of beer info
beer1startvol = 4.99 # starting volume of keg
		

# Beer 2 (Middle Tap) Variables ========================================================================================================
beer2name = "Kolsch" # 20 char limit
beer2srm = SRM3 # srm color value
beer2style = "Kolsch" # 19 char limit
beer2OG = "OG: 1.048 SG" # layout like OG: #.### SG
beer2ibu = "IBU: 18.6" # layout like IBU: ##.#
beer2abv = "ABV: 5.0%/VOL" # layout like ABV: #.#%/VOL
beer2glasspic = pint # select from Beer Glass Variables
beer2textcolor = BLACK # text color of beer info
beer2startvol = 4.98 # starting volume of keg
		

# Beer 3 (Right Tap) Variables =========================================================================================================
beer3name = "Empty" # 20 char limit
beer3srm = RED # srm color value
beer3style = "N/A" # 19 char limit
beer3OG = "OG: x.xxx SG" # layout like OG: #.### SG
beer3ibu = "IBU: xx.x" # layout like IBU: ##.#
beer3abv = "ABV: x.x%/VOL" # layout like ABV: #.#%/VOL
beer3glasspic = nokeg # select from Beer Glass Variables
beer3textcolor = BLACK # text color of beer info
beer3startvol = 4.95 # starting volume of keg
