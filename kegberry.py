...
VIEW_HEIGHT = 800 # my numbers 600, original number 576
...
background = pygame.image.load('rva.jpg')
...
def renderThings(flowMeter1, flowMeter2, flowMeter3, screen, 
	...
	if flowMeter1.enabled:
		rendered = screenfont.render(flowMeter1.getFormattedTotalPour() + " / " + str(beer1startvol), True, beer1textcolor, BEER1Bg)
...
#	screen.blit(beer1glasspic, (0, 325))
	...
	if flowMeter2.enabled:
		rendered = screenfont.render(flowMeter2.getFormattedTotalPour() + " / " + str(beer2startvol), True, beer2textcolor, BEER2Bg)
...
#	screen.blit(beer2glasspic, (((VIEW_WIDTH / 2) - (rendered.get_rect().width / 2)), 325))
	...
	if flowMeter3.enabled:
		rendered = screenfont.render(flowMeter3.getFormattedTotalPour() + " / " + str(beer3startvol), True, beer3textcolor, BEER3Bg)
